...
import org.bsuir.utils.AppUtil;
...
public class Email {
	...
	public Email(String from, String toList, String subject, String message, String email) {
		this();
		this.from = from;
	...
	public Email(String from, String toList, String ccList, String subject, String message, String email) {
		this();
		this.from = from;
		this.subject = subject;
		this.message = message;
